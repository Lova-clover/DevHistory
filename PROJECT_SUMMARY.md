...
![DevHistory](../images/dashboard.png)

**상태:** 모든 핵심 기능 완성 (2025.11.30)

## 완성된 주요 기능

- ✅ GitHub OAuth 인증 및 본인 소유 레포지토리 동기화
- ✅ Velog, Solved.ac 데이터 자동 수집
- ✅ 대시보드 통계 및 트렌드 (주간 증감)
- ✅ LLM 기반 블로그 글 자동 생성 (Velog 스타일 매칭)
- ✅ 포트폴리오 페이지 및 PDF 내보내기
- ✅ 생성된 콘텐츠 관리 (수정/삭제)
- ✅ 다크모드 완벽 지원
- ✅ 포트폴리오 커스터마이징 (이름, 이메일, 소개, 표시 레포 개수)
